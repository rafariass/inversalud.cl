...
!(function (e, t) {
      ...
      preFilter: {
        ...
        PSEUDO: function (e) {
          ...
          return Y.CHILD.test(e[0])
            ? null
            : (e[3] ? (e[2] = e[4] || e[5] || '') : n && U.test(n) && (t = a(n, !0)) && (t = n.indexOf(')', n.length - t) - n.length) && ((e[0] = e[0].slice(0, t)), (e[2] = n.slice(0, t))),
              e.slice(0, 3));
        },
      },
      filter: {
      ...
      for (
        ...
        if ((n = r.relative[e[u].type])) d = [me(ve(d), n)];
          ...
          if ((n = r.filter[e[u].type].apply(null, e[u].matches))[b]) {
            ...
            return xe(
              u > 1 && ve(d),
              u > 1 && ge(e.slice(0, u - 1).concat({ value: ' ' === e[u - 2].type ? '*' : '' })).replace(I, '$1'),
              n,
              u < i && be(e.slice(u, i)),
              i < o && be((e = e.slice(i))),
              i < o && ge(e)
      ...
      function (e, t) {
        d.fn[e] = function (n, r) {
          ...
          return (
            ...
            this.length > 1 && (A[e] || (i = d.uniqueSort(i)), S.test(e) && (i = i.reverse())),
            this.pushStack(i)
          );
        };
      }
  ...
  d.extend({
    ...
    ready: function (e) {
      (!0 === e ? --d.readyWait : d.isReady) ||
        ((d.isReady = !0), (!0 !== e && --d.readyWait > 0) || (j.resolveWith(r, [d]), d.fn.triggerHandler && (d(r).triggerHandler('ready'), d(r).off('ready'))));
    },
  }),
  ...
  (f.ownFirst = '0' === L),
    ...
    d(function () {
      ...
      (n = r.getElementsByTagName('body')[0]) &&
        ...
        void 0 !== t.style.zoom &&
          ((t.style.cssText = 'display:inline;margin:0;border:0;padding:1px;width:1px;zoom:1'), (f.inlineBlockNeedsLayout = e = 3 === t.offsetWidth), e && (n.style.zoom = 1)),
        n.removeChild(i));
    }),
    (function () {
    ...
    for (var o, a, s, u, l, c, p, h = e.length, g = re(t), m = [], v = 0; v < h; v++)
      if ((a = e[v]) || 0 === a)
        if ('object' === d.type(a)) d.merge(m, a.nodeType ? [a] : a);
          ...
          for (
            u = u || g.appendChild(t.createElement('div')), l = (Z.exec(a) || ['', ''])[1].toLowerCase(), p = ie[l] || ie._default, u.innerHTML = p[1] + d.htmlPrefilter(a) + p[2], o = p[0];
            o--;
  ...
  (d.event = {
      ...
      if (
        ...
        for (h = 0; (u = g[h++]) && !t.isPropagationStopped(); )
          (t.type = h > 1 ? l : f.bindType || m),
            ...
            (a = s && u[s]) && a.apply && M(u) && ((t.result = a.apply(u, n)), !1 === t.result && t.preventDefault());
        ...
        for (s = d.event.handlers.call(this, e, l), t = 0; (o = s[t++]) && !e.isPropagationStopped(); )
          for (e.currentTarget = o.elem, n = 0; (a = o.handlers[n++]) && !e.isImmediatePropagationStopped(); )
            (e.rnamespace && !e.rnamespace.test(a.namespace)) ||
              ((e.handleObj = a),
              (e.data = a.data),
              void 0 !== (r = ((d.event.special[a.origType] || {}).handle || a.handler).apply(o.elem, u)) && !1 === (e.result = r) && (e.preventDefault(), e.stopPropagation()));
    ...
    fix: function (e) {
      ...
      var t,
        ...
        s = this.fixHooks[o];
      for (
        s || (this.fixHooks[o] = s = pe.test(o) ? this.mouseHooks : de.test(o) ? this.keyHooks : {}), i = s.props ? this.props.concat(s.props) : this.props, e = new d.Event(a), t = i.length;
        t--;
    ...
    (d.Event = function (e, t) {
      ...
      e && e.type
        ? ((this.originalEvent = e), (this.type = e.type), (this.isDefaultPrevented = e.defaultPrevented || (void 0 === e.defaultPrevented && !1 === e.returnValue) ? me : ve))
        : (this.type = e),
        t && d.extend(this, t),
  ...
  function qe(e, t, n, r) {
    ...
    var i,
      ...
      m = t[0],
      v = d.isFunction(m);
    if (v || (h > 1 && 'string' == typeof m && !f.checkClone && Ee.test(m)))
    ...
    if (h && ((i = (c = ce(t, e[0].ownerDocument, !1, e, r)).firstChild), 1 === c.childNodes.length && (c = i), i || r)) {
      ...
      if (s)
        for (l = u[u.length - 1].ownerDocument, d.map(u, je), p = 0; p < s; p++)
          (a = u[p]),
            ee.test(a.type || '') &&
              !d._data(a, 'globalEval') &&
              d.contains(l, a) &&
              (a.src ? d._evalUrl && d._evalUrl(a.src) : d.globalEval((a.text || a.textContent || a.innerHTML || '').replace(ke, '')));
      c = i = null;
    }
    return e;
  }
  function _e(e, t, n) {
    for (var r, i = t ? d.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
      n || 1 !== r.nodeType || d.cleanData(oe(r)), r.parentNode && (n && d.contains(r.ownerDocument, r) && ae(oe(r, 'script')), r.parentNode.removeChild(r));
    return e;
  }
  d.extend({
    ...
    clone: function (e, t, n) {
      ...
      if (
        (f.html5Clone || d.isXMLDoc(e) || !we.test('<' + e.nodeName + '>') ? (o = e.cloneNode(!0)) : ((Se.innerHTML = e.outerHTML), Se.removeChild((o = Se.firstChild))),
        !((f.noCloneEvent && f.noCloneChecked) || (1 !== e.nodeType && 11 !== e.nodeType) || d.isXMLDoc(e)))
      )
        for (r = oe(o), s = oe(e), a = 0; null != (i = s[a]); ++a) r[a] && He(i, r[a]);
      if (t)
        if (n) for (s = s || oe(e), r = r || oe(o), a = 0; null != (i = s[a]); a++) Le(i, r[a]);
        else Le(e, o);
  ...
  function Re(e) {
    ...
    return (
      n ||
        (('none' !== (n = Oe(e, t)) && n) ||
          ((t = ((Fe = (Fe || d("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement))[0].contentWindow || Fe[0].contentDocument).document).write(),
          t.close(),
          (n = Oe(e, t)),
          Fe.detach()),
        (Me[e] = n)),
    ...
    function c() {
      ...
      d.appendChild(u),
        ...
        e.getComputedStyle &&
          ...
          ((c = l.appendChild(r.createElement('div'))).style.cssText = l.style.cssText =
    ...
    ? (($e = function (t) {
      ...
      (ze = function (e, t, n) {
        var r,
          ...
          s = e.style;
        return (
          ('' !== (a = (n = n || $e(e)) ? n.getPropertyValue(t) || n[t] : void 0) && void 0 !== a) || d.contains(e.ownerDocument, e) || (a = d.style(e, t)),
          n &&
            !f.pixelMarginRight() &&
            Be.test(a) &&
            Pe.test(t) &&
    ...
    : Ie.currentStyle &&
      ...
      (ze = function (e, t, n) {
        var r,
          ...
          s = e.style;
        return (
          null == (a = (n = n || $e(e)) ? n[t] : void 0) && s && s[t] && (a = s[t]),
          Be.test(a) &&
            !Xe.test(t) &&
            ((r = s.left),
  ...
  function nt(e, t) {
    for (var n, r, i, o = [], a = 0, s = e.length; a < s; a++)
      (r = e[a]).style &&
        ...
        (n = r.style.display),
        t
          ? (o[a] || 'none' !== n || (r.style.display = ''), '' === r.style.display && U(r) && (o[a] = d._data(r, 'olddisplay', Re(r.nodeName))))
  ...
  d.extend({
    ...
    style: function (e, t, n, r) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        ...
        if (
          ...
          null != n &&
            n == n &&
            ('number' === o && (n += (i && i[3]) || (d.cssNumber[s] ? '' : 'px')),
    ...
    css: function (e, t, n, r) {
      var i,
        ...
        s = d.camelCase(t);
      return (
        (t = d.cssProps[s] || (d.cssProps[s] = tt(s) || s)),
    ...
    d.each(['height', 'width'], function (e, t) {
      d.cssHooks[t] = {
        get: function (e, n, r) {
          if (n)
            return Je.test(d.css(e, 'display')) && 0 === e.offsetWidth
              ? We(e, Qe, function () {
                  return ot(e, t, r);
                })
              : ot(e, t, r);
    ...
    f.opacity ||
      (d.cssHooks.opacity = {
        get: function (e, t) {
          return Ye.test((t && e.currentStyle ? e.currentStyle.filter : e.style.filter) || '') ? 0.01 * parseFloat(RegExp.$1) + '' : t ? '1' : '';
        },
        set: function (e, t) {
          var n = e.style,
            r = e.currentStyle,
          ...
          (n.zoom = 1),
            ((t >= 1 || '' === t) && '' === d.trim(o.replace(Ve, '')) && n.removeAttribute && (n.removeAttribute('filter'), '' === t || (r && !r.filter))) ||
              (n.filter = Ve.test(o) ? o.replace(Ve, i) : o + ' ' + i);
        },
      }),
    ...
    (at.propHooks = {
      _default: {
        ...
        set: function (e) {
          d.fx.step[e.prop]
            ? d.fx.step[e.prop](e)
            : 1 !== e.elem.nodeType || (null == e.elem.style[d.cssProps[e.prop]] && !d.cssHooks[e.prop])
            ? (e.elem[e.prop] = e.now)
  ...
  (d.Animation = d.extend(ht, {
    ...
    prefilters: [
      function (e, t, n) {
        ...
        1 === e.nodeType &&
          ...
          'inline' === ('none' === (l = d.css(e, 'display')) ? d._data(e, 'olddisplay') || Re(e.nodeName) : l) &&
            'none' === d.css(e, 'float') &&
            (f.inlineBlockNeedsLayout && 'inline' !== Re(e.nodeName) ? (h.zoom = 1) : (h.display = 'inline-block'))),
        n.overflow &&
          ((h.overflow = 'hidden'),
          f.shrinkWrapBlocks() ||
            c.always(function () {
        ...
        if (d.isEmptyObject(p)) 'inline' === ('none' === l ? Re(e.nodeName) : l) && (h.display = l);
          ...
          p))
            (a = pt(g ? m[r] : 0, r, c)), r in m || ((m[r] = a.start), g && ((a.end = a.start), (a.start = 'width' === r || 'height' === r ? 1 : 0)));
      },
    ],
    ...
    d.each({ slideDown: dt('show'), slideUp: dt('hide'), slideToggle: dt('toggle'), fadeIn: { opacity: 'show' }, fadeOut: { opacity: 'hide' }, fadeToggle: { opacity: 'toggle' } }, function (
      e,
      t
    ) {
        ...
        select: {
          get: function (e) {
            for (var t, n, r = e.options, i = e.selectedIndex, o = 'select-one' === e.type || i < 0, a = o ? null : [], s = o ? i + 1 : r.length, u = i < 0 ? s : o ? i : 0; u < s; u++)
              if (
                ((n = r[u]).selected || u === i) &&
                (f.optDisabled ? !n.disabled : null === n.getAttribute('disabled')) &&
                (!n.parentNode.disabled || !d.nodeName(n.parentNode, 'optgroup'))
              ) {
    ...
    d.extend({
      attr: function (e, t, n) {
        ...
        if (3 !== o && 8 !== o && 2 !== o)
          return void 0 === e.getAttribute
            ? d.prop(e, t, n)
            : ((1 === o && d.isXMLDoc(e)) || ((t = t.toLowerCase()), (i = d.attrHooks[t] || (d.expr.match.bool.test(t) ? yt : vt))),
              void 0 !== n
                ? null === n
      ...
      removeAttr: function (e, t) {
        ...
        if (o && 1 === e.nodeType)
          for (; (n = o[i++]); )
            (r = d.propFix[n] || n),
              d.expr.match.bool.test(n) ? ((Tt && wt) || !bt.test(n) ? (e[r] = !1) : (e[d.camelCase('default-' + n)] = e[r] = !1)) : d.attr(e, n, ''),
  ...
  d.extend({
    ...
    ajax: function (t, n) {
      ...
      if (
        ...
        (T.success = T.done),
        (T.error = T.fail),
        (f.url = ((t || f.url || Bt) + '').replace(Lt, '').replace(Ft, Wt[1] + '//')),
        ...
        (f.dataTypes = d
          ...
          .match(H) || ['']),
        null == f.crossDomain &&
          ((r = Mt.exec(f.url.toLowerCase())),
          (f.crossDomain = !(!r || (r[1] === Wt[1] && r[2] === Wt[2] && (r[3] || ('http:' === r[1] ? '80' : '443')) === (Wt[3] || ('http:' === Wt[1] ? '80' : '443')))))),
      ...
      (o = f.url),
      f.hasContent ||
        (f.data && ((o = f.url += (Dt.test(o) ? '&' : '?') + f.data), delete f.data),
        !1 === f.cache && (f.url = Ht.test(o) ? o.replace(Ht, '$1_=' + At++) : o + (Dt.test(o) ? '&' : '?') + '_=' + At++)),
  ...
  e.attachEvent &&
    ...
    (f.cors = !!en && 'withCredentials' in en),
    (en = f.ajax = !!en) &&
            ...
            ((t = r.createElement('script')).async = !0),
              ...
              (t.onload = t.onreadystatechange = function (e, n) {
                (n || !t.readyState || /loaded|complete/.test(t.readyState)) &&
                  ((t.onload = t.onreadystatechange = null), t.parentNode && t.parentNode.removeChild(t), (t = null), n || o(200, 'success'));
              }),
    ...
    d.ajaxPrefilter('json jsonp', function (t, n, r) {
      ...
      if (s || 'jsonp' === t.dataTypes[0])
        return (
          ...
          s ? (t[s] = t[s].replace(on, '$1' + i)) : !1 !== t.jsonp && (t.url += (Dt.test(t.url) ? '&' : '?') + t.jsonp + '=' + i),
